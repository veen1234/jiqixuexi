...
本文件主要功能：
    1、使用keras搭建 U-Net 网络
    2、多分类：使用 Softmax 激活函数
    3、计算损失：categorical_crossentropy
    4、计算精度：categorical_accuracy
"""
...
def unet(input_size,num_class, pretrained_weights = False,model_summary=False,model_plot=False):
...
if __name__=='__main__':
    unet(input_size=(64,64,36), num_class=9, model_summary=True)
